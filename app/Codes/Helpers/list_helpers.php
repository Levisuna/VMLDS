...
if ( ! function_exists('get_list_status_po')) {
    /**
     * @return array
     */
    function get_list_status_po(): array
    {
        return [
            1 => __('general.need_confirmation'),
            2 => __('general.waiting_confirmation'),
            3 => __('general.preparing_process'),
            4 => __('general.shipping_process'),
            80 => __('general.complete'),
            90 => __('general.void'),
            99 => __('general.cancel'),
        ];
...
if ( ! function_exists('get_list_status_tagihan')) {
    /**
     * @return array
     */
    function get_list_status_tagihan(): array
    {
        return [
            1 => __('general.pending'),
            80 => __('general.complete')
